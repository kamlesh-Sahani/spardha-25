...
export async function POST(req: NextRequest) {
  ...
  try {
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    ${
                      status === "approved"
                        ? "<p>🎉 Congratulations! Your team is approved.</p>"
                        : ""
                    }
                    ${
                      status === "rejected"
                        ? "<p>⚠️ Unfortunately, your request was not approved.</p>"
                        : ""
                    }
                    ${
                      reason
                        ? '<div class="reason"><strong>Reason:</strong> ' +
                          reason +
                          "</div>"
                        : ""
                    }
                    <p>Password: <span class="cta-button">${
                      team.password
                    }</span></p>
                    ...
                    ${
                      status === "approved"
                        ? '<a href="' +
                          whatsappGroupLink +
                          '" class="cta-button">Join WhatsApp Group</a>'
                        : ""
                    }  
    ...
    await sendMail(
      captainEmail,
      `Status Update for Team ${team.teamID}`,
      htmlTemplate
    );
    return NextResponse.json(
      {
