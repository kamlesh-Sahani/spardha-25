...
const eventImage = [
  ...
  },
  {
    ...
    rules: [
      ...
      "The Referee shall have power to disqualify a player from a match, an event, or a competition for seriously unfair or offensive behaviour .",
      "Only the captain/coach of the team is allowed to talk to the jury of appeal regarding any appeal or protest at a fee of ₹ 1000.00.",
      "Only winner and runner-up team will be rewarded by cash prize, certificate of appreciation, and medals.",
    ],
  ...
  },
  {
    ...
    rules: [
      ...
      "Weight Categories:  <65 Kg, 65+ - 75Kg, and 75+ - 85Kg.",
      ...
      "Competition Wear: Competitors must wear posing shorts—board shorts ((Men’s physique Olympia)) or bodybuilding trunks are not allowed.",
  ...
  },
  {
    ...
    rules: [
      "Players must be the Bonafide students of a college/Institute/University.",
      "The players must have to report 30 min. before the scheduled time of match.",
      "If the player does not turn up within 10 minutes of the scheduled time, the opposite party will get a walkover.",
      "If player has touched a piece during game, has to move the same piece.",
      " First Round",
      "First round will be elimination round.",
      "Each player will have (10+5) minutes to complete the game.",
      "If the game will draw, the players have to go for blitz round for time control (3+0).",
      " Second Round",
      "Game format will be Swiss Tournament Rules (10 + 5 Time Control), only 4 (Four) rounds will be played.",
      " General Regulations Second Round:",
      "The tournament will be conducted in accordance with the latest FIDE Laws of Chess.",
      "The tournament will use the Swiss system pairing format. The number of 4 (Four) rounds will be played.",
      " Time Control & Format:",
      "Each player will have (10+5) minutes to complete the game.",
      "Players must press the clock with the same hand used to make the move.",
      "If a player oversteps the time limit, they lose the game unless the opponent does not have sufficient material to checkmate, in which case the game is declared a draw. ",
      "	Pairings & Tiebreaks:",
      "Pairings will be made using the Swiss system, based on the official Swiss pairing rules. If all are still equal, a Blitz tiebreak may be played",
      "	Fair Play & Conduct:",
      "Players must not use any external assistance, including electronic devices or chess engines.",
      "Mobile phones must be in airplane mode or kept in a designated area. If a phone rings during a game, the player forfeits the game.",
      "Any form of cheating or unfair conduct will lead to immediate disqualification.",
      "Players must respect their opponents and the arbiters. Unsporting behaviour will not be tolerated.",
      "	Notation & Claims:",
      "Players are not required to record moves in rapid time control.",
      "In case of a dispute, the arbiter’s decision will be final.",
      "If an illegal move is made, the opponent may claim a win if the player makes two illegal moves in the same game.",
      "A player may claim a draw if a position is repeated three times.",
      "Only winner and runner-up team will be rewarded by cash prize, certificate of appreciation and medals.",
      "Cash Prize reward may increase, depending on the number of registrations.",
    ],
